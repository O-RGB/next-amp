const METADATA_KEY = "nextstudioModelOptimization";
...
/**
 * Load a graph that was optimized and verified by nextstudio-model-builder.
  ...
  return {
    ...
    async load() {
      ...
      try {
        ...
        console.warn("[NextStudio AI] Prebuilt optimized graph failed; loading embedded compatibility graph", error);
        preferOptimized = false;
        resetState();
