...
echo "=================================================="
echo "    NEXTSONA ENGINE STANDALONE SINGLE-BINARY BUILDER"
echo "=================================================="
...
go build -ldflags="-s -w" -o nextsona-engine .

# 3. Build Windows standalone binary
echo "[*] Step 3: Cross-compiling Windows standalone executable (x64)..."
CC="zig cc -target x86_64-windows-gnu" CXX="zig c++ -target x86_64-windows-gnu" GOOS=windows GOARCH=amd64 CGO_ENABLED=1 go build -ldflags="-s -w" -o nextsona-engine.exe .

echo ""
echo "=================================================="
echo "    BUILD SUCCESSFUL! STANDALONE BINARIES CREATED:"
echo "=================================================="
ls -lh nextsona-engine nextsona-engine.exe
echo ""
