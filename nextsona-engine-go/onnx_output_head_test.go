...
func TestCompactONNXOutputRuntime(t *testing.T) {
	if compatEnv("NEXTSONA_RUN_COMPACT_ONNX", "NEXTSTUDIO_RUN_COMPACT_ONNX") != "1" {
		t.Skip("set NEXTSONA_RUN_COMPACT_ONNX=1 to run the native compact-output session")
	}
