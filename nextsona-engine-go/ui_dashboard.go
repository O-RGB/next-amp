...
func (d *Dashboard) Start() {
	...
	go func() {
		...
		fmt.Println("[*] NextSona Engine closed. Goodbye!")
		os.Exit(0)
	}()
...
func (d *Dashboard) renderLogLine() {
	...
	fmt.Printf("[⚡ NextSona Engine] Dev: %s | Status: %s | Mode: %s | Chunks: #%d (%.1f MB) | Latency: %.1f ms\n",
...
func (d *Dashboard) renderFrame() {
	...
	// TITLE
	b.WriteString(fmt.Sprintf("\033[1;36m  ⚡ NextSona Audio Engine\033[0m  \033[90mv%s\033[0m\n", Version))
