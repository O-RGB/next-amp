(function () {
  ...
  window.NextSonaRemoteProtocol = protocol;
  // A cached Remote page from the previous release may execute alongside the
  // renamed host. Keep one read-only alias during the migration window.
  window.NextStudioRemoteProtocol = protocol;
})();
