(function () {
  ...
  const LANGUAGE_KEY = "nextsona-language";
  const LEGACY_LANGUAGE_KEY = "nextstudio-language";
  ...
  const translations = {
    en: {
      ...
      "hardware.eyebrow": "COMPATIBILITY", "hardware.title": "Browser and\ndevice support.", "hardware.body": "NextSona uses the browser capabilities available on your device. AI is optional, and lighter processing is available when a machine has less headroom.", "hardware.link": "Read the privacy policy",
    ...
    th: {
      ...
      "hardware.eyebrow": "อุปกรณ์ที่รองรับ", "hardware.title": "การรองรับของ browser\nและอุปกรณ์", "hardware.body": "NextSona ใช้ความสามารถของ browser และอุปกรณ์ที่มี AI เป็นตัวเลือก และมีการประมวลผลที่เบาลงสำหรับเครื่องที่มีทรัพยากรจำกัด", "hardware.link": "อ่านนโยบายความเป็นส่วนตัว",
      ...
      "faq.eyebrow": "คำถาม", "faq.title": "คำถามที่\nพบบ่อย", "faq.ai.q": "AI จะโหลดเมื่อไหร่?", "faq.ai.a": "หลังจากคุณเปิดโหมด AI vocal เท่านั้น หน้าเว็บสาธารณะจะไม่โหลดโมเดลล่วงหน้า", "faq.remote.q": "Remote ควบคุมอะไรได้บ้าง?", "faq.remote.a": "Remote ส่งค่าที่ตรวจสอบแล้ว เช่น volume, pitch, vocal mode และ video timing โดยไม่ส่ง audio stream", "faq.data.q": "เสียงที่บันทึกเก็บไว้ที่ไหน?", "faq.data.a": "เสียงที่บันทึกและการตั้งค่าจะอยู่ใน browser หรือ Extension storage ในเครื่อง คุณเล่น ดาวน์โหลด หรือลบเทคของตัวเองได้", "faq.compat.q": "GPU ทุกเครื่องทำงานเหมือนกันไหม?", "faq.compat.a": "ไม่เหมือนกัน การเร่งผลขึ้นกับ browser, driver, ระบบปฏิบัติการ และฮาร์ดแวร์ NextSona จึงมีตัวเลือกที่เบากว่าสำหรับเครื่องที่จำกัด",
      "cta.eyebrow": "NEXTSONA", "cta.title": "เครื่องมือเสียง\nสำหรับใช้งานทุกวัน", "cta.primary": "ดูฟีเจอร์", "cta.contact": "ติดต่อทีม", "cta.support": "เลี้ยงกาแฟผู้พัฒนา", "footer.tagline": "เครื่องมือเสียงบน browser โดย NextFeeder Labs", "footer.contact": "ติดต่อ", "footer.support": "สนับสนุนโปรเจกต์", "footer.built": "พัฒนาโดย NextFeeder Labs",
      "policy.label": "ความเป็นส่วนตัวและความไว้วางใจ", "policy.title": "นโยบายความเป็นส่วนตัว", "policy.intro": "คำอธิบายที่ชัดเจนว่า NextSona จัดการข้อมูลอย่างไร", "policy.effective": "วันที่มีผล: 13 กันยายน 2026", "policy.version": "ฉบับ 1.1", "terms.label": "ข้อกำหนดการใช้งาน", "terms.title": "ข้อกำหนดการใช้งาน", "terms.intro": "ข้อกำหนดพื้นฐานสำหรับการใช้ NextSona", "terms.effective": "วันที่มีผล: 13 กันยายน 2026", "terms.version": "ฉบับ 1.0"
    }
  };
  ...
  let initial = "en";
  try {
    initial = localStorage.getItem(LANGUAGE_KEY) || "";
    if (!initial) {
      initial = localStorage.getItem(LEGACY_LANGUAGE_KEY) || "en";
      if (initial === "en" || initial === "th") localStorage.setItem(LANGUAGE_KEY, initial);
    }
  } catch (_) {}
