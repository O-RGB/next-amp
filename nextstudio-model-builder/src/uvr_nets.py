...
class CascadedASPPNet(nn.Module):
    ...
    def _forward_outputs(self, x):
        ...
        return self.out(h), mix, aux1, aux2

    def forward_logits(self, x):
        logits, _, _, _ = self._forward_outputs(x)
        return logits

    def forward(self, x):
        logits, mix, aux1, aux2 = self._forward_outputs(x)
