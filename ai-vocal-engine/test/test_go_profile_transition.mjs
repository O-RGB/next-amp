...
const source = fs.readFileSync(
  ...
  .replace('import {\n  estimateOutputLatency,\n  selectFastWebGpuOutputTarget\n} from "./output-latency-estimator.mjs";\n', 'const estimateOutputLatency = () => null;\nconst selectFastWebGpuOutputTarget = () => ({ enabled: false, readyThreshold: 2, fallbackReadyThreshold: 2, startupHoldSamples: 0, startupHoldMs: 0 });\n')
