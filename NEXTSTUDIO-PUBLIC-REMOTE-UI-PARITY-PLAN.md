# NextStudio Public Remote UI Parity Plan

## เป้าหมาย

ปรับหน้า `nextstudio-public-site/remote/` ให้มีโครงสร้าง UX, ลำดับ section, ตำแหน่ง control, ค่า control และพฤติกรรมเหมือนหน้า Remote ที่ Extension ส่งให้โทรศัพท์ใช้งานจริงทุกจุด แต่เปลี่ยนเฉพาะงานภาพให้เป็นธีมของ `nextstudio-public-site`
...
- Layout, control และ runtime behavior หลัก: `next-amp-extension/remote/remote-ui-bundle.js`
- วิธีที่ Extension เปิด Remote และส่ง UI: `next-amp-extension/popup.js` บริเวณ bootloader และ `MOUNT_UI`
- ฝั่ง host, state และ protocol ที่รับคำสั่ง: `next-amp-extension/offscreen.js`
- ค่าเดียวกับหน้า Extension หลักที่ใช้ตรวจสอบซ้ำ: `next-amp-extension/popup.html` และ `next-amp-extension/popup.js`

### ไฟล์ที่เป็นเพียงของเก่าหรือ reference รอง

- `next-amp-extension/remote/index.html`
- `next-amp-extension/remote/styles.css`
- `next-amp-extension/remote/app.js`
- `next-amp-extension/remote/dos-remote.html`
...
- Markup: `nextstudio-public-site/remote/index.html`
- Style: `nextstudio-public-site/assets/css/remote.css`
- Runtime: `nextstudio-public-site/assets/js/remote.js`
- Validation/protocol: `nextstudio-public-site/assets/js/remote-protocol.js`
- ธีมอ้างอิง: `nextstudio-public-site/assets/css/site.css`
...
- ห้ามแก้ `next-amp-extension/remote/remote-ui-bundle.js` เพื่อให้เว็บดูเหมือนกัน
