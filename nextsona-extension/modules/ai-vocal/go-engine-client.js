/**
 * NextSona Go Native Engine Client
 * 
 * High-performance WebSocket bridge connecting NextSona Extension
  ...
  connect() {
    ...
    try {
      ...
      this.ws.onopen = () => {
        ...
        console.log("[NextSona Go Engine] Connected to", this.url);
        if (this.onStatusChange) {
    ...
    if (typeof e.data === "string") {
      try {
        ...
        if (msg.type === "READY") {
          ...
          console.log("[NextSona Go Engine] Handshake READY:", msg);
          if (this.onStatusChange) {
