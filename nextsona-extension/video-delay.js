...
(function setupActionNotification() {
  ...
  function getHost() {
    let host = document.getElementById("nextsona-action-notification");
    if (host) return host;
    host = document.createElement("div");
    host.id = "nextsona-action-notification";
    ...
    root.innerHTML = `
      ...
      <div class="toast" role="status" aria-live="polite"><div class="bar"><span class="title"><span class="led">●</span><span>NEXTSONA</span></span><span class="source">ACTION</span></div><div class="body"><span class="icon">✓</span><span class="text"></span></div></div>`;
